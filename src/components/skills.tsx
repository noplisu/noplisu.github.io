                      ...
                      {subcategory.technologies.map((technology, techIndex) => {
                        ...
                        const content = (
                          <div className="flex flex-col h-full">
                            <div className="flex items-center space-x-4 mb-4">
                              {technology.image && (
                                <div className="flex-shrink-0 w-16 h-16 bg-gray-50 dark:bg-gray-700 rounded-xl flex items-center justify-center group-hover:bg-primary-50 dark:group-hover:bg-gray-600 transition-colors duration-300">
                                  <Image
                                    width={48}
                                    height={48}
                                    src={imageSrc}
                              ...
                              <div className="flex-1 min-w-0">
                                <h4 className="text-lg font-semibold text-gray-900 dark:text-gray-100 group-hover:text-primary-600 dark:group-hover:text-red-500 transition-colors duration-300">
                                  {technology.name}
                                </h4>
                                {technology.externalLink && (
                                  <div className="mt-1">
                                    <span className="text-xs text-primary-500 dark:text-red-400 font-medium">View Certificate →</span>
                                  </div>
                                )}
                              </div>
                            </div>
                        ...
                        return technology.externalLink ? (
                          <a
                            ...
                            className="group bg-white dark:bg-gray-800 rounded-xl p-6 shadow-soft dark:shadow-hard hover:shadow-medium dark:hover:shadow-glow-red card-hover transition-all duration-300 block border border-gray-100 dark:border-gray-700"
                          >
                            {content}
                          </a>
                        ) : (
